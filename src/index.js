import { IxDatabase } from "./js/repository/db";
var { dom, get, post } = require("./comm");
var { Section } = require("./section");
var { MilMap } = require("./js/map3d/milmap");
var { KMilSymbolCollection } = require("./js/collection/kmilsymbolcollection");
var { JsonByFolder } = require("./js/repository/json-by-folder");
var { DrawInCesium } = require("./js/draw/base");
var { mariaConfig } = require("./js/repository/dataset");
var { MariaDB } = require("./js/repository/maria_db");
require("./js/ui/olive-input");
require("./js/ui/olive-tree");

...
const { asCanvas } = require("./symbol/ascanvas");
Symbol.prototype.asCanvas = asCanvas;

const { canvasDraw } = require("./symbol/canvasdraw");
...
const { asSVG } = require("./symbol/assvg");
...
const { getColors } = require("./symbol/getcolors");
...
const { getMetadata } = require("./symbol/getmetadata");
Symbol.prototype.getMetadata = getMetadata;

const { getOptions } = require("./symbol/getoptions");
Symbol.prototype.getOptions = getOptions;

const { getSize } = require("./symbol/getsize");
Symbol.prototype.getSize = getSize;

const { getStyle } = require("./symbol/getstyle");
Symbol.prototype.getStyle = getStyle;

const { isValid } = require("./symbol/isvalid");
Symbol.prototype.isValid = isValid;

const { setOptions } = require("./symbol/setoptions");
Symbol.prototype.setOptions = setOptions;

Symbol.prototype.toDataURL = function() {
    return (
        "data:image/svg+xml;base64," +
        window.btoa(unescape(encodeURIComponent(this.asSVG())))
    );
};

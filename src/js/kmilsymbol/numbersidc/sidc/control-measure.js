const metadata_number = require("../metadata");
const getIcons_number = require("../geticons");
const icons = require("../../iconparts/tactical-points");
const labels = require("../labels/tactical-points");

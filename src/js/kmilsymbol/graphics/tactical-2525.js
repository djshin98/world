...
module.exports = function tacticalPoints(sidc, modular) {
    ...
    sidc['G-G-OLI---'] = modular["침투로"]; //TACGRP.C2GM.OFF.LNE.INFNLE
    ...
    sidc['G-G-OAA---'] = ["다각형구역"]; //TACGRP.C2GM.OFF.ARS.ASTPSN
    sidc['G-G-OAK---'] = ["다각형구역"]; //TACGRP.C2GM.OFF.ARS.ATKPSN
    sidc['G-G-OAF---'] = modular["사격선"]; //TACGRP.C2GM.OFF.ARS.AFP
    sidc['G-G-OAS---'] = modular["사격지원진지"]; //TACGRP.C2GM.OFF.ARS.SFP
    sidc['G-G-OAO---'] = ["다각형구역"]; //TACGRP.C2GM.OFF.ARS.OBJ
    sidc['G-G-OAP---'] = ["다각형구역"]; //TACGRP.C2GM.OFF.ARS.PBX
    ...
    sidc['G-G-SAO---'] = ["다각형구역"]; //TACGRP.C2GM.SPL.ARA.AOO

...
module.exports = function tacticalPoints(sidc, modular) {
    ...
    //sidc['G-T-------'] = [];//2.X.1
    //sidc['G-T-G-----'] = [];//2.X.1.1
    sidc["G-T-GB----"] = modular["BLOCK"]; //2.X.1.1.1
    sidc["G-T-GH----"] = modular["BYPASS"]; //2.X.1.1.2
    sidc["G-T-GY----"] = modular["BYPASS"]; //2.X.1.1.3
    sidc["G-T-GC----"] = modular["CANALIZE"]; //2.X.1.1.4
    sidc["G-T-GX----"] = modular["CLEAR"]; //2.X.1.1.5
    //sidc['G-T-GJ----'] = [];//2.X.1.1.6
    //sidc['G-T-GK----'] = [];//2.X.1.1.7
    //sidc['G-T-GKF---'] = [];//2.X.1.1.7.1
    sidc["G-T-GL----"] = modular["DELAY"]; //2.X.1.1.8
    //sidc['G-T-GLT---'] = [];//2.X.1.1.8.1
    //sidc['G-T-GT----'] = [];//2.X.1.1.10
    sidc["G-T-GF----"] = modular["FIX"]; //2.X.1.1.11
    //sidc['G-T-GA----'] = [];//2.X.1.1.12
    //sidc['G-T-GAS---'] = [];//2.X.1.1.12.1
    sidc["G-T-GE----"] = modular["ISOLATE"]; //2.X.1.1.14
    ...
    sidc["G-C-MOLAS-"] = modular["SUPPORTING ATTACK"]; //2.X.2.1.5.2.1.4
    sidc["G-C-MOLAM-"] = modular["MAIN ATTACK"]; //2.X.2.1.5.2.1.5
    ...
    sidc["G-C-MSGA--"] = modular["AMBUSH"]; //2.X.2.1.6.1.2
    ...
    sidc["G-C-MSAN--"] = modular["NAMED AREA OF INTEREST"]; //2.X.2.1.6.3.2
    sidc["G-C-MSAT--"] = modular["TARGETED AREA OF INTEREST"]; //2.X.2.1.6.3.3
    //sidc['G-C-B-----'] = [];//2.X.2.2
    ...
    sidc["G-C-FAS---"] = modular["FIRE SUPPORT AREA"]; //2.X.2.3.3.1
    sidc["G-C-FAC---"] = modular["AIRSPACE COORDINATION AREA"]; //2.X.2.3.3.2
    ...
    sidc["G-C-FAI---"] = modular["FREE FIRE AREA"]; //2.X.2.3.3.6
